  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-6 w-full md:w-1/2">
        ...
        <div className="flex items-center space-x-6 mt-6">
          <button
            ...
            dark:bg-[#5084FF] dark:text-[#ffffff] dark:hover:text-[#5084FF] dark:hover:bg-[#ffff]"
          >
            Contáctame
          </button>
      ...
      <div className="w-full md:w-1/2 flex justify-center md:justify-end">
        <div className="w-64 h-80 bg-gray-300 border-2 rounded-xl">
          {/* Acá va la imagen o placeholder */}
        </div>
      </div>
    </section>
  );
